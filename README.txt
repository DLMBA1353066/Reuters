...
Then, in the second the three classification algorithms are presented in any aspect: the values of parameters we need to specify, the construction of the confusion matrix, and the computation of the Precision, Recall, Accuracy and F-Measure for each class and also for Micro and Macro averaging.
...
Also, is reported the R code for the contingencty table, the computation and plot of the silhouette and the computation of the Weighted Average Entropy.
